fdescribe('$compile', function () {
    ...
    function makeInjectorWithDirectives() {
        ...
        return createInjector(['ng', function ($compileProvider) {
            $compileProvider.directive(...args);
        }]);
    }
    ...
    describe('attributes', function () {
        ...
        it('terminates class directive attribute value at semicolon sdfasdfasd', function () {
            registerAndCompile(
                'myDirective',
                '<div class="my-app my-directive: my attribute value; some-other-class"></div>',
                function (element, attrs) {
                    expect(attrs.myDirective).toEqual('my attribute value');
                }
            );
